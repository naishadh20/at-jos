...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800346:	e8 54 00 00 00       	call   80039f <vcprintf>
	cprintf("\n");
  80034b:	c7 04 24 30 10 80 00 	movl   $0x801030,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80049e:	0f be 80 fc 0f 80 00 	movsbl 0x800ffc(%eax),%eax
  8004a5:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800669:	50                   	push   %eax
  80066a:	68 14 10 80 00       	push   $0x801014
  80066f:	53                   	push   %ebx
  800670:	56                   	push   %esi
  ...
  800681:	52                   	push   %edx
  800682:	68 1d 10 80 00       	push   $0x80101d
  800687:	53                   	push   %ebx
  800688:	56                   	push   %esi
  ...
  8006a6:	b8 0d 10 80 00       	mov    $0x80100d,%eax
...
cprintf("x %d, y %x, z %d\n", x, y, z);//-------------------------->> Extra
  ...
  800864:	68 20 10 80 00       	push   $0x801020
