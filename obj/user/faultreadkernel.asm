	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 f1 0d 80 00 	movsbl 0x800df1(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a2:	50                   	push   %eax
  8003a3:	68 09 0e 80 00       	push   $0x800e09
  8003a8:	53                   	push   %ebx
  8003a9:	56                   	push   %esi
  ...
  8003ba:	52                   	push   %edx
  8003bb:	68 12 0e 80 00       	push   $0x800e12
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003df:	b8 02 0e 80 00       	mov    $0x800e02,%eax
...
cprintf("x %d, y %x, z %d\n", x, y, z);//-------------------------->> Extra
  ...
  80059d:	68 15 0e 80 00       	push   $0x800e15
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b03:	e8 d0 f5 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800b08:	c7 04 24 25 0e 80 00 	movl   $0x800e25,(%esp)
