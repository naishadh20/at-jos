	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f4:	0f be 80 11 0e 80 00 	movsbl 0x800e11(%eax),%eax
  8001fb:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003bf:	50                   	push   %eax
  8003c0:	68 29 0e 80 00       	push   $0x800e29
  8003c5:	53                   	push   %ebx
  8003c6:	56                   	push   %esi
  ...
  8003d7:	52                   	push   %edx
  8003d8:	68 32 0e 80 00       	push   $0x800e32
  8003dd:	53                   	push   %ebx
  8003de:	56                   	push   %esi
  ...
  8003fc:	b8 22 0e 80 00       	mov    $0x800e22,%eax
...
cprintf("x %d, y %x, z %d\n", x, y, z);//-------------------------->> Extra
  ...
  8005ba:	68 35 0e 80 00       	push   $0x800e35
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b20:	e8 d0 f5 ff ff       	call   8000f5 <vcprintf>
	cprintf("\n");
  800b25:	c7 04 24 45 0e 80 00 	movl   $0x800e45,(%esp)
